      ...
      <div className="flex flex-col lg:flex-row gap-0 border-2 border-foreground">
        ...
        >
          ...
          <Image
            ...
            alt="Isometric view of a brutalist component library gallery with UI blocks and modules"
            fill
        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                A component library built for
                <br />
                <span className="text-[#ea580c]">raw shipping speed</span>
              </motion.h2>
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Every component ships as plain, readable source. No black
                  boxes. No lock-in. Just accessible markup, sensible defaults,
                  and copy-paste code you own outright — dropped straight into
                  your project.
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Built by front-end engineers who spent a decade shipping
                  design systems in production. We believe UI code should be
                  inspectable, themeable, and brutally fast to integrate.
                </p>
              </motion.div>
