...
const LOG_LINES = [
  "> npx sys.int@latest add",
  "> Fetching registry index...",
  "> Resolving components: 47",
  "> Installing brutal-button...",
  "> Installing terminal-card...",
  "> Installing marquee-ticker...",
  "> Writing components/ui/...",
  "> Merging globals.css tokens...",
  "> Formatting with prettier...",
  "> Typecheck: passed",
  "> 0 errors, 0 warnings",
  "> Runtime deps added: 0",
  "> Bundle impact: 12.4kb gz",
  "> Status: READY",
  "> --------- INSTALL COMPLETE ---------",
]
