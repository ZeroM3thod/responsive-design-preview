  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="147" label="Components" delay={500} />
        <ScrambleNumber target="38.4K" label="Weekly Installs" delay={800} />
        <ScrambleNumber target="12.4kb" label="Avg Bundle Size" delay={1100} />
        <ScrambleNumber target="0" label="Runtime Deps" delay={1400} />
      </div>
    </div>
  )
}
